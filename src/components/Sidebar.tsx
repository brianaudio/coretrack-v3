...
// Interface for menu items with section grouping
interface MenuItem {
  id: ModuleType
  label: string
...
const menuItems: MenuItem[] = [
  ...
  // ADVANCED FEATURES - Special tools
  {
...
// Group menu items by sections for organized display
...
export default function Sidebar({ 
  ...
  })).filter(section => section.items.length > 0) // Only show sections that have items
