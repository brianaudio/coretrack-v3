...
export default function InventoryCenter() {
  ...
  const [activeTab, setActiveTab] = useState<'inventory' | 'analytics' | 'movements' | 'insights' | 'wastage' | 'wastage-thresholds' | 'wastage-reports'>('inventory')
        ...
        <div className="max-w-7xl mx-auto p-6">
          <div className="bg-white/70 backdrop-blur-lg rounded-3xl border border-white/20 shadow-xl">
            ...
            <div className="border-b border-gray-100">
              <div className="px-6">
                <nav className="flex justify-center space-x-8 overflow-x-auto scrollbar-hide" aria-label="Tabs">
                  ...
                  <button
                    onClick={() => setActiveTab('wastage-thresholds')}
                    className={`py-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap transition-colors ${
                      activeTab === 'wastage-thresholds'
                  ...
                  <button
                    onClick={() => setActiveTab('wastage-reports')}
                    className={`py-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap transition-colors ${
                      activeTab === 'wastage-reports'
            ...
            <div className="p-6">
              ...
              {activeTab === 'wastage' && (
                <div className="space-y-6">
                  <WastageTracker inventoryItems={inventoryItems} />
                </div>
              )}

              {activeTab === 'wastage-thresholds' && (
                <div className="space-y-6">
                  <WastageThresholds inventoryItems={inventoryItems} />
                </div>
              )}
