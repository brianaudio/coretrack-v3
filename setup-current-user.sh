...
echo "🚀 Setting up Firebase user for enterprise access..."

# Create a Node.js script to initialize the current user
cat > temp-user-setup.mjs << 'EOF'
...
node temp-user-setup.mjs

echo "🧹 Cleaning up..."
rm temp-user-setup.mjs
